...
from api.models.community   import Base as Community_Base
...
def reset_database():
    ...
    Chat_Base.metadata.drop_all(bind=engine)
    Community_Base.metadata.drop_all(bind=engine)

    Community_Base.metadata.create_all(bind=engine)
